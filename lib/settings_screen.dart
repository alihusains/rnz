...
class _SettingsScreenState extends State<SettingsScreen> {
  ...
  Future<void> _saveLanguageSelection() async {
    if (_selectedLanguage == null || _selectedLanguage == _currentLanguage) {
      return;
    }
  ...
  Widget build(BuildContext context) {
    ...
    return WillPopScope(
      onWillPop: () async {
        // Return whether language was changed
                  ...
                  child: Column(
                    children: [
                      ...
                      SizedBox(
                        ...
                        child: ElevatedButton(
                          style: ElevatedButton.styleFrom(
                            backgroundColor: _selectedLanguage !=
                                    _currentLanguage
                                ? AppTheme.primaryGreen
                                : AppTheme.primaryGreen.withValues(alpha: 0.5),
                            elevation:
                      ...
                      SizedBox(
                        ...
                        child: OutlinedButton(
                          ...
                          onPressed: () {
                            // Reset selected language to current
                            setState(() {
